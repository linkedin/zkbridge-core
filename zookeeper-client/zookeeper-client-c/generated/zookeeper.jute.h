...
void deallocate_PathWithStat(struct PathWithStat*);
...
struct GetChildrenPaginatedRequest {
    char * path;
    int32_t maxReturned;
    int64_t minCzxid;
    int32_t czxidOffset;
...
void deallocate_GetChildrenPaginatedRequest(struct GetChildrenPaginatedRequest*);
...
struct GetChildrenPaginatedResponse {
    struct String_vector children;
    struct Stat stat;
    int64_t nextPageCzxid;
    int32_t nextPageCzxidOffset;
};
...
void deallocate_GetChildrenPaginatedResponse(struct GetChildrenPaginatedResponse*);
