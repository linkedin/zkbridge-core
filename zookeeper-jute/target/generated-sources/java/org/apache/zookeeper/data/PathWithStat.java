...
public class PathWithStat implements Record {
  private String path;
  ...
  public int compareTo (Object peer_) throws ClassCastException {
    if (!(peer_ instanceof PathWithStat)) {
      throw new ClassCastException("Comparing different types of records.");
    }
    PathWithStat peer = (PathWithStat) peer_;
    int ret = 0;
  ...
  public static String signature() {
    return "LPathWithStat(sLStat(lllliiiliil))";
  }
}
