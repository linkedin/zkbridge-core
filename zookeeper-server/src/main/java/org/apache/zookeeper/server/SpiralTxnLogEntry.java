 ...
 */
public final class SpiralTxnLogEntry {
    private final Record txn;
    private final ServerAwareTxnHeader header;
    private final TxnDigest digest;

    public SpiralTxnLogEntry(Record txn, ServerAwareTxnHeader header, TxnDigest digest) {
        this.txn = txn;
        this.header = header;
        this.digest = digest;
    }
